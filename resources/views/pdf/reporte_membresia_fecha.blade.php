  ...
  <body>
    ...
    <main>
        <div id="details" class="clearfix">
          ...
          <div id="invoice">
            <h3 style="color: #ff6000">REPORTE DE MEMBRESIAS</h3>
            <div class="date"></div>
          </div>
        </div>
        <table border="0" cellspacing="0" cellpadding="0">
          <thead>
            <tr>
              ...
              <th class="unit">FECHA INICIO</th>
              <th class="desc">FECHA FIN</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="unit">{{ $membresia->fecha_inicio }}</td>
              <td class="desc">{{ $membresia->fecha_fin }}</td>
