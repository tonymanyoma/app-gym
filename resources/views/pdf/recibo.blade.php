  ...
  <body>
    ...
    <main>
        <div id="details" class="clearfix">
          <div id="client">
              <div class="to">ADMINISTRADOR: {{ $membresia->admin }}</div>
              <h2 class="name"></h2>
              <h2 class="name"></h2>
          ...
          <div id="invoice">
            <h3 style="color: #ff6000">RECIBO DE PAGO</h3>
            <div class="date"></div>
          </div>
        </div>
        <table border="0" cellspacing="0" cellpadding="0">
          ...
          <tbody>
            ...
            <tr>
              <td class="no">{{ $membresia->nombre_cliente }}</td>
              <td class="desc">{{ $membresia->fecha_inicio }}</td>
              <td class="unit">{{ $membresia->fecha_fin }}</td>
              <td class="desc">{{ $membresia->nombre_plan }}</td>
              <td class="unit">${{ number_format($membresia->valor) }}</td>
          ...
          <tfoot>
              <tr>
                ...
                <td style="text-align:center;">${{ number_format($membresia->valor) }}</td>
              </tr>
            </tfoot>
